import {type App, type ButtonComponent, FuzzySuggestModal, Modal, Notice, Setting} from "obsidian";
import type {GroupSnippet, GroupSnippetsSettings, Snippets} from "./interface";
